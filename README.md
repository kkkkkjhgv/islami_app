...
- This is a personal project for Islamic content and resources
- The app is designed with clean architecture principles
- All Quran and Hadith content is stored locally for offline access
- Prayer times are fetched from external APIs based on location



## 📄 License

This project is private and owned by kkkkkjhgv.
...
- GitHub: [@kkkkkjhgv](https://github.com/kkkkkjhgv)

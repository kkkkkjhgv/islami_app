...
import 'package:islami_app/features/layout/models/most_recently_model.dart';
...
class _QuranScreenState extends State<QuranScreen> {
  ...
  void initState() {
    super.initState();
    _filteredSurahs = quranSurahs; // Initialize with all Surahs
  ...
  void _onSearchChanged() {
    setState(() {
      ...
      if (_searchQuery.isEmpty) {
        ...
        _filteredSurahs = quranSurahs.where((surah) {
              ...
              if (_filteredSurahs.isEmpty)
                Center(
                  child: Padding(
                    ...
                    child: Text(
                      "No Surahs found matching '$_searchQuery'",
                      style: TextStyle(
                        fontFamily: "Janna",
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                ...
                itemBuilder: (context, index) => GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(
                      ...
                      arguments: _filteredSurahs[index],
                    );
                  },
                  child: SuraCardWidget(surahModel: _filteredSurahs[index]),
                ),
